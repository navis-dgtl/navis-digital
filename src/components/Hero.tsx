...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent/20 rounded-full blur-[120px] animate-glow"
      ...
      <div className="container relative z-10 max-w-5xl mx-auto text-center animate-fade-in-up">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto">
          Bridge the gap between AI capabilities and business outcomes with expert prompt engineering, implementation
          strategy, and adoption training.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Button size="lg" variant="outline" className="text-lg px-8 py-6" onClick={scrollToServices}>
            Explore Services
          </Button>
        </div>
