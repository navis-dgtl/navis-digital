  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "hsl(var(--primary))", // Cyan #99E9F2
        ...
        accent: {
          DEFAULT: "hsl(var(--accent))", // Purple #A250FF
      ...
      keyframes: {
        ...
        glow: {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(187 75% 76% / 0.3), 0 0 40px hsl(272 100% 65% / 0.2)",
          },
          "50%": {
            boxShadow: "0 0 40px hsl(272 100% 65% / 0.6), 0 0 80px hsl(187 75% 76% / 0.3)",
          },
        },
        "gradient-shift": {
